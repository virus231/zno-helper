...
import { Card, CardHeader, CardBody, FormInput, Button, FormSelect  } from 'shards-react'
...
function CreateTestSingle():JSX.Element {
        ...
        <>
            <Card className="my-4">
                ...
                <CardBody className="question-input">
                    <div className="">
                        <FormInput placeholder="Напишіть ваше запитанння тут" className="mt-2 mb-4"  />
                    </div>
                </CardBody>
                <CardBody className="question-input">
...
export default CreateTestSingle;
